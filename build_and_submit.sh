...
$path_to_spark/bin/spark-submit --conf spark.eventLog.enabled=true --conf spark.eventLog.dir="/tmp" --driver-memory 8g --class com.sparkProject.$1 $master_ip target/scala-2.11/* 1>OK.log 2>KO.log
