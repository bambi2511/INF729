...
object Preprocessor {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = spark
      ...
      .csv("/home/bambi/source/INF729/Scala_TP/data/train.csv")
    ...
    dfFiltered.write.mode(SaveMode.Overwrite).parquet("/home/bambi/source/INF729/Scala_TP/data/prepared_trainingset")
